...
// GENERAL.
$string['pluginname'] = 'Boost Campus Extra';
$string['choosereadme'] = 'Theme Boost Campus extra is a child theme of Boost Campus and used to use all features of the theme Boost Campus but with the possibility to change colors easily and add own SCSS.';

// SETTINGS.
$string['configtitle'] = 'Boost Campus Extra settings';
