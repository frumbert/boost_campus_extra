 ...
 * @return string
 */
function theme_boost_campus_extra_get_extra_scss($theme) {
 ...
 * @return string
 */
function theme_boost_campus_extra_get_main_scss_content($theme) {
    global $CFG;
    ...
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_boost_campus_extra', 'preset', 0, '/', $filename))) {
        // This preset file was fetched from the file area for theme_boost_campus_extra and not theme_boost (see the line above).
    ...
    $pre = file_get_contents($CFG->dirroot . '/theme/boost_campus_extra/scss/pre.scss');
    ...
    $post = file_get_contents($CFG->dirroot . '/theme/boost_campus_extra/scss/post.scss');
 ...
 * @return array
 */
function theme_boost_campus_extra_get_pre_scss($theme) {
