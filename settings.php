...
if ($ADMIN->fulltree) {
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingboost_campus_extra',
        get_string('configtitle', 'theme_boost_campus_extra', null, true));

    // Create general tab.
    $page = new admin_settingpage('theme_boost_campus_extra_general', get_string('generalsettings', 'theme_boost', null, true));

    // Settings title to group preset related settings together with a common heading. We don't want a description here.
    $name = 'theme_boost_campus_extra/presetheading';
    $title = get_string('presetheadingsetting', 'theme_boost_campus', null, true);
    $setting = new admin_setting_heading($name, $title, null);
    $page->add($setting);

    // Replicate the preset setting from theme_boost.
    $name = 'theme_boost_campus_extra/preset';
    ...
    $fs = get_file_storage();
    $files = $fs->get_area_files($context->id, 'theme_boost_campus_extra', 'preset', 0, 'itemid, filepath, filename', false);
    ...
    $name = 'theme_boost_campus_extra/presetfiles';
    ...
    $name = 'theme_boost_campus_extra/brandcolorheading';
    ...
    $name = 'theme_boost_campus_extra/brandcolor';
    ...
    $name = 'theme_boost_campus_extra/brandsuccesscolor';
    ...
    $name = 'theme_boost_campus_extra/brandinfocolor';
    ...
    $name = 'theme_boost_campus_extra/brandwarningcolor';
    ...
    // Variable $brand-warning-color.
    $name = 'theme_boost_campus_extra/branddangercolor';
    ...
    $page = new admin_settingpage('theme_boost_campus_extra_advanced', get_string('advancedsettings', 'theme_boost', null, true));

    // Raw SCSS to include before the content.
    $name = 'theme_boost_campus_extra/scsspre';
    ...
    $name = 'theme_boost_campus_extra/scss';
