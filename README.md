moodle-theme_boost_campus_extra
===============================
...
Based on [boost_campus_child](https://github.com/moodleuulm/moodle-theme_boost_campus_child). 

Requirements
------------

This plugin requires Moodle 3.11+
This plugins requires boost_campus 2021122800


Motivation for this theme
-------------------------

Boost campus has a number of shortcomings because it is based on Boost which has soome annoying theming decisions built right in.

The header area is bigger ![header](big-header.png)

The SCORM player turns off pretty much everything for FOCUS ![scorm](scorm.png)

... and some other minor tweaks I use
...
Site administration -> Appearance -> Themes -> Boost Campus Extra.
...
* Copy the directoy /theme/boost_campus_extra to /theme/boost_campus_foo
* Search and replace the string "theme_boost_campus_extra" within this directory with "theme_boost_campus_foo"
* Rename the file /theme/boost_campus_extra/lang/en/theme_boost_campus_extra.php to /theme/boost_campus_foo/lang/en/theme_boost_campus_foo.php
...
https://github.com/moodleuulm/moodle-theme_boost_campus_extra
...
https://github.com/moodleuulm/moodle-theme_boost_campus_extra/issues
...
https://github.com/moodleuulm/moodle-theme_boost_campus_extra/pulls
