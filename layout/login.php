 ...
 * @copyright based on code from boost_campus by Kathrin Osswald, Ulm University
...
// tim - add css to identify which login page we are on
$extraclasses = [];
if ($PAGE->url->compare(new moodle_url('/login/index.php'), URL_MATCH_BASE)) {
    $extraclasses[] = 'login-page';
} else if ($PAGE->url->compare(new moodle_url('/login/signup.php'), URL_MATCH_BASE)) {
    $extraclasses[] = 'signup-page';
}
