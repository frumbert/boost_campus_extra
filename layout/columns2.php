...
// $minimalheader = isset($PAGE->layout_options['minimal_header']) && $PAGE->layout_options['minimal_header'];
if ($minimalheader) {
...
$topblocks = $OUTPUT->blocks('main-top');
...
//tim: if a section is empty, why render it and have it take up space?
...
require_once($CFG->dirroot . '/theme/boost_campus/layout/includes/footer.php');
require_once($CFG->dirroot . '/theme/boost_campus/layout/includes/imagearea.php');
require_once($CFG->dirroot . '/theme/boost_campus/layout/includes/footnote.php');
// MODIFICATION END.

// MODIFICATION START.
// Render columns2.mustache from boost_campus.
echo $OUTPUT->render_from_template('theme_boost_campus_extra/columns2', $templatecontext);
// MODIFICATION END.
// @codingStandardsIgnoreStart
/* ORIGINAL START.
